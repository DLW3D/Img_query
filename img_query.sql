...
--
-- Host: 127.0.0.1:3306
-- Generation Time: 2019-02-18 16:49:27
-- 服务器版本： 5.7.19
-- PHP Version: 7.1.9
...
CREATE TABLE IF NOT EXISTS `picture` (
  ...
  KEY `uid` (`uid`)
) ENGINE=InnoDB AUTO_INCREMENT=27 DEFAULT CHARSET=utf8 COMMENT='图片表';

--
-- 转存表中的数据 `picture`
--

INSERT INTO `picture` (`pid`, `name`, `url`, `uid`, `date`, `used`) VALUES
(2, '昆西吃草', NULL, 1, '2019-02-08 17:03:39', 0),
(6, '迟到30年 新闻总是那么及时', NULL, 0, '2019-02-08 20:33:25', 0),
(9, '昆西趴桌子', NULL, 1, '2019-02-09 17:39:02', 0),
(10, '昆西牛吃草', NULL, 1, '2019-02-09 17:39:46', 2),
...
(19, '5', NULL, 0, '2019-02-18 18:15:47', 0),
(22, '给大佬递伏特加', 'https://i.loli.net/2019/02/18/5c6aafb3df924.png', 0, '2019-02-18 21:14:26', 4),
(24, '给我也整一个', 'https://i.loli.net/2019/02/18/5c6ac4e305615.png', 0, '2019-02-18 22:44:49', 1),
(25, '滑稽', NULL, 0, '2019-02-19 00:24:55', 0),
(26, '阅兵场VV', 'https://i.loli.net/2019/02/19/5c6adcb105e24.jpg', 0, '2019-02-19 00:26:23', 0);
...
CREATE TABLE IF NOT EXISTS `pic_comment` (
  ...
  KEY `pid` (`pid`),
  KEY `uid` (`uid`)
) ENGINE=InnoDB AUTO_INCREMENT=8 DEFAULT CHARSET=utf8 COMMENT='图片评论表';
...
(6, 17, 0, 0, '测试', '2019-02-18 21:07:12'),
(7, 22, 1, 0, '这是个第三方图片平台来源的图片', '2019-02-18 22:40:49');
